...
@section('content')
    <div>
        ...
        <form class="m-t" role="form" action="{{ route('postchooseid',$doctor_data->id) }}" method="POST" autocomplete="off">
            @csrf
            ...
            <div class="form-group @error('Sample_Collection_Addresh'){{ "has-error" }} @enderror">
                <input type="text" class="form-control" placeholder="Enter Your Sample Collection Address" name="Sample_Collection_Addresh" id="Sample_Collection_Addresh"
                    value="{{ old('Sample_Collection_Addresh') }}">
            </div>
            <p class="py-0 text-danger text-small" style="text-align-last : left !important">
            ...
            <div class="form-group @error('schedule_time'){{ "has-error" }} @enderror">
                <input type="datetime-local" class="form-control" placeholder="Select Date and Time for Sample Collection" name="schedule_time" id="schedule_time"
